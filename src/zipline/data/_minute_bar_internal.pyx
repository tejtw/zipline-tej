from numpy cimport ndarray, longlong_t
...
def minute_value(ndarray[longlong_t, ndim=1] market_opens,
                 Py_ssize_t pos,
...
def find_position_of_minute(ndarray[longlong_t, ndim=1] market_opens,
                            ndarray[longlong_t, ndim=1] market_closes,
                            longlong_t minute_val,
                            short minutes_per_day,
                            bool forward_fill):
    """
...
def find_last_traded_position_internal(
        ndarray[longlong_t, ndim=1] market_opens,
        ndarray[longlong_t, ndim=1] market_closes,
        longlong_t end_minute,
        longlong_t start_minute,
        volumes,
        short minutes_per_day):
