...
class AlgorithmSimulator(object):
    ...
    def __init__(
        ...
        self.treasury_source = treasury_source       #20230209 (by MRC) for treasury return column in perf
        # =============
        # Logging Setup
        # =============
    ...
    def transform(self):
        ...
        def on_exit():
            ...
            self.treasury_source = self.current_data = self.data_portal = None   #20230209 (by MRC) for treasury return column in perf
